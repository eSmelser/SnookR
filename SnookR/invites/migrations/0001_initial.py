    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='substitutes.SessionEvent')),
                ('invitee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='substitutes.Sub')),
            ],
            options={
                'abstract': False,
            },
